  ...
  try {
    ...
    return {
      ...
      benchmark: {
        ...
        upstream_source: stockBenchmark.upstream_source || null,
        timestamp: stockBenchmark.timestamp,
        source_timestamp: stockBenchmark.source_timestamp ?? stockBenchmark.timestamp,
        fetched_at: stockBenchmark.fetched_at || null,
        reference_date: stockBenchmark.reference_date ?? null,
